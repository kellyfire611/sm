...
return [
    ...
    'store_sanpham' => ['id' => 'id','ma_sanpham' => 'Mã sản phẩm','ten_sanpham' => 'Tên sản phẩm','ten_hoatchat' => 'Tên hoạt chất','nongdo_hamluong' => 'Nồng độ hàm lượng','sokiemsoat' => 'Số kiểm soát','anh' => 'Hình ảnh sản phẩm','donvitinh_id' => 'Đơn vị tính','nha_sanxuat_id' => 'Nhà sản xuất','nuoc_sanxuat_id' => 'Nước sản xuất','deleted_at' => 'deleted_at','created_at' => 'created_at','updated_at' => 'updated_at',],
